...
def expand_logical_to_fingers(
    ...
    for logical_node in logical_nodes:
        ...
        for i, finger_id in enumerate(finger_ids):
            ...
            # Abutment flags: inner fingers share both edges;
            # leftmost shares only its right; rightmost shares only its left.
            finger_node["geometry"]["abut_left"]   = (i > 0)
            finger_node["geometry"]["abut_right"]  = (i < n_fingers - 1)
