"""
Topology Analysis Core Logic
=============================
Canonical implementation of layout topology analysis and symmetry detection.
Extracted from ai_agent/agents/topology_analyst.py — zero logic changes.

Functions:
- analyze_json: Convert raw layout JSON structures into a prompt-ready text snapshot.
- extract_symmetry_block: Detect diff pairs and produce a machine-readable [SYMMETRY] block.
"""
