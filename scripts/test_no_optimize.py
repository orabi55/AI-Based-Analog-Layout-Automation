"""
Test the cleaned-up pipeline WITHOUT optimize_all_rows_orientations.
"""
import sys
import json
...
print("=== Testing Pipeline WITHOUT optimize_all_rows_orientations ===\n")
...
# Step 1: Resolve overlaps and add fillers (includes maximize_interleaved_abutment)
print("\n[Step 1] Resolving overlaps and adding fillers...")
