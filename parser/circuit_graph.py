"""
circuit_graph.py
Transforms parsed SPICE netlists and geometry layout maps into traversable NetworkX graphs. 
It analyzes component connectivity and attempts to categorize edges behaviorally 
(e.g., shared gate, shared source/drain). Provides merging logic mapping spatial geometry onto electrical graphs.
"""
